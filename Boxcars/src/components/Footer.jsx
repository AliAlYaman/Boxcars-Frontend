      ...
      <div className={`px-8 sm:px-10 lg:px-12 ${text ? "text-white" : null}`}>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 text-center max-md:items-start">
          <div className="flex flex-col items-start">
            ...
            <p
              className={`font-thin ${text ? "text-white" : "text-gray-500"} `}
            >
        ...
        {/* Links Section */}
        <div className={`grid grid-cols-2 md:grid-cols-4 gap-8 ${text ? "text-white" : "text-gray-700"} text-sm text-center md:text-left`}>
          <div>
        ...
        <div className={`flex flex-col md:flex-row justify-between mt-10 ${text ? "text-white" : "text-gray-700"} text-sm`}>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className={`flex space-x-4 text-xl ${text ? "text-white" : "text-gray-700"}`}>
